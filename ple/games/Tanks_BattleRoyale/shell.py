...
class Shell(Environment):
    def __init__(self, raw_image, position, speed, direction, index):
        ...
        self.IMAGES = {
            "shell_right1": pygame.transform.scale(pygame.image.load(os.path.join(self._dir, 'assets/shell_right1.png')), (16, 16)).convert_alpha(),
            ...
            "shell_up2": pygame.transform.scale(pygame.image.load(os.path.join(self._dir, 'assets/shell_up2.png')), (16, 16)).convert_alpha(),
